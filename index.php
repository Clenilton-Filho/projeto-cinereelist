...
<body>
  ...
  <nav id="side-menu">
    ...
    <section id="links">
      <a class="link botao-cadastrar-entrar" href="pages/login.html">CADASTRAR-SE</a>
      <a class="link botao-cadastrar-entrar" href="pages/cadastro.php">CADASTRAR-SE</a>
    </section>
  </nav>

  <main id="main">
    <section id="secao-em-alta">
      <div id="div-trailer-1" class="div-trailer">
        <video id="trailer-1" class="trailer" src="media/videos/chairs-loop.mp4" autoplay="on" muted loop playsinline></video>
      </div>
      ...
      <div id="conteiner-transparente-em-alta">
        ...
        <div id="div-filmes-em-alta">
          ...
          <button id="mudar-em-alta-esquerda" class="botao-mudar-filmes" onclick="rolarEsquerda(event)">
              &leftarrow;
            </button>
          <button id="mudar-em-alta-direita" class="botao-mudar-filmes" onclick="rolarDireita(event)">
            &rightarrow;
          </button>
        </div>
      </div>
    ...
    <a href="#secao-generos">
      <button id="rolar-tela-baixo" class="rolar-tela">
        &DownArrow;
      </button>
    </a>

    <section id="secao-generos">
      <div id="div-trailer-2" class="div-trailer" >
        <video id="trailer-2" class="trailer" src="media/videos/chairs-loop.mp4" autoplay="on" muted loop playsinline></video>
      </div>
    ...
    <a href="#main">
      <button id="rolar-tela-cima" class="rolar-tela">
        &UpArrow;
      </button>
    </a>
  </main>
